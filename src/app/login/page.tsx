...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState("demo@aurum.finance");
    ...
    <main className="flex min-h-screen items-center justify-center px-6">
      <div className="w-full max-w-md">
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-ink-secondary">Sign in to the AURUM console</p>
        </div>
        ...
        <form onSubmit={onSubmit} className="panel space-y-4 p-7">
          ...
          <button type="submit" disabled={busy} className="btn-gold w-full rounded-xl px-4 py-3 text-sm disabled:opacity-60">
